...
class LslidarChLayer {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('scan_channel')) {
        ...
        this.scan_channel = new Array(128).fill(new sensor_msgs.msg.LaserScan());
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.scan_channel.length !== 128) {
      throw new Error('Unable to serialize array field scan_channel - length must be 128')
    }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LslidarChLayer(null);
  ...
  static datatype() {
    ...
    return 'lslidar_ch128x1_msgs/LslidarChLayer';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LslidarChLayer(null);
    if (msg.scan_channel !== undefined) {
      resolved.scan_channel = new Array(128)
      ...
      resolved.scan_channel = new Array(128).fill(new sensor_msgs.msg.LaserScan())
    }
